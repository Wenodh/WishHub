      ...
      >
        <div className="p-8 sm:p-10 rounded-3xl border border-neutral-200/60 dark:border-neutral-800/60 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-xl premium-shadow space-y-8">
          <div className="text-center space-y-2">
              ...
              <h1 className="text-3xl font-black tracking-tight text-neutral-950 dark:text-white">Welcome Back</h1>
              <p className="text-neutral-500 dark:text-neutral-400 font-semibold text-sm">Sign in to manage your workspaces</p>
          </div>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-neutral-500 dark:text-neutral-400 font-medium">
              ...
              <Link href="/signup" className="text-neutral-950 dark:text-white font-extrabold hover:underline underline-offset-4">
                Create an account
              </Link>
            </p>
          </div>
