...
import { Sparkles, ArrowRight, Bookmark, Compass, Heart } from "lucide-react";
...
export default function Page() {
  ...
  return (
    <PublicLayout>
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-6 py-20 relative overflow-hidden">
        <motion.div
